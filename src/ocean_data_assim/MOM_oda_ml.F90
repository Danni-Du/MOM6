...
character(len=255)  :: danni_ANN_name = '/gpfs/f5/gfdl_sd/world-shared/Danni.Du/ECDA_data/ML/danni_ANN_M8_ens_TzBzdivmldtaufluxRiTzBzdivRi_2003_2009_20epoch.nc'
...
contains
    ...
    subroutine oda_ml_inference(ml_config,ml_data)
        ...
        real, dimension(15) :: thetao_zgrad_sigma, so_zgrad_sigma, PRHO_zgrad_sigma, div_sigma, output_DT_sigmas, uo_zgrad_sigma, vo_zgrad_sigma
