...
character(len=255)  :: danni_ANN2_name = '/gpfs/f5/gfdl_sd/world-shared/Danni.Du/ECDA_data/ML/M8/M8_ens_attention_encoder_decoder_2003_2014_20epoch_huber_ann2.nc'
...
contains
    ...
    subroutine init_oda_ml_features(ml_data,nk)
        ...
        allocate(ml_data%U_left_south(nk),source=0.0)
        allocate(ml_data%U_right_south(nk),source=0.0)
        allocate(ml_data%U_left_north(nk),source=0.0)
        allocate(ml_data%U_right_north(nk),source=0.0)
        allocate(ml_data%V_north_left(nk),source=0.0)
        allocate(ml_data%V_south_left(nk),source=0.0)
        allocate(ml_data%V_north_right(nk),source=0.0)
        allocate(ml_data%V_south_right(nk),source=0.0)
