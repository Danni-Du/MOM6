...
type, public :: ocean_oda_ml_config ; private
    ...
    real, dimension(16,61)  :: l1_weight
...
character(len=255)  :: danni_ANN_name = '/gpfs/f5/gfdl_sd/world-shared/Danni.Du/ECDA_data/ML/danni_ANN_M4_TzBzdivmldUz_2007_2016_10epoch_bs1000_l2.nc'
        ...
        if (mask_Tuv < 5.0) then
            ...
            if (zl_index_3mld == 0) then ! if 3 mld not found
                ...
                if (z_l(zl_index_3mld+1) > ml_data%bathyT .OR. &
                    ...
                    ANN_input(47:61) = uo_zgrad_sigma*1000
